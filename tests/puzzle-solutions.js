...
export function solvePuzzle(id,variant='perfect',omit=null){
 ...
 for(let t=0;t<50000&&!g.result;t++){
  ...
  if(id===6){at('climb',0,'climb',150,340);at('bridge',0,'platform',684,340);at('back',0,'turn',840,340);at('tunnel',0,'bash',445,340,-1);if(done.has('tunnel'))at('home',0,'turn',330,340,-1);}
