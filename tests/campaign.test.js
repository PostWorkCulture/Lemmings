...
export function solveLevel(index){if(LEVELS[index].puzzleId)return solvePuzzle(index).g;const g=new Game(index);let job=0,held=false,released=false,lastAction=0;
